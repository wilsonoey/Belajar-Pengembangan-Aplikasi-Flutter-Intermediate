...
class _TambahCeritaPageState extends State<TambahCeritaPage> {
  ...
  void _onTap(LatLng position) async {
    final info = await geo.placemarkFromCoordinates(position.latitude, position.longitude);
    final place = info[0];
    ...
    setState(() {
      ...
      _locationController.text = '${place.subLocality}, ${place.locality}, ${place.postalCode}, ${place.country}';

      markers.clear(); // Hapus marker sebelumnya
      markers.add(
        Marker(
